    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.CharField(choices=[('Recursos Humanos', 'Recursos Humanos'), ('IT', 'IT'), ('Finanzas', 'Finanzas'), ('Operaciones', 'Operaciones')], max_length=50, verbose_name='Departamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Administrador', 'Administrador'), ('Miembro', 'Miembro')], default='Miembro', max_length=50, verbose_name='Rol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('descripcion', models.TextField(verbose_name='Descripción')),
                ('fecha_asignada', models.DateField(auto_now_add=True, verbose_name='Fecha asignada')),
